...
- [x] **Phase 1: Discovery and Standardization (CLI + File System)**
...
- [ ] **Phase 2: State Control (Metadata Table)**
...
- [ ] **Phase 3: The Executor (Transactions and Pure SQL)**
...
- [ ] **Phase 4: Reversal and Integrity (Down Migrations)**
...
- [ ] **Phase 5: Production Security (Advisory Locks)**
